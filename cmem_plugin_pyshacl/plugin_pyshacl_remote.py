...
class ShaclValidationRemote(WorkflowPlugin):
    """Plugin class"""
    ...
    def check_parameters(  # noqa: C901
        self,
    ) -> None:
    ...
    def execute(
        ...
        data_graph = (
            get_query_api_endpoint().format("default") + f"?default_graph_uri={self.data_graph_uri}"
        )
        ...
        _conforms, validation_graph, _results_text = validate(
            ...
            do_owl_imports=self.owl_imports,
            sparql_mode=True,
        )
